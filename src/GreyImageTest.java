...
public class GreyImageTest extends TestCase {
	...
	public void testPartB() throws Exception {
		...
		for (int i = 0; i < beforeCallToProcessImage.length; i++) {
			for (int j = 0; j < beforeCallToProcessImage[0].length; j++) {
				System.out.print(beforeCallToProcessImage[i][j] + " ");
			}
			System.out.println("");
		}
		System.out.println(" ");
		for (int i = 0; i < afterCallToProcessImage.length; i++) {
			for (int j = 0; j < afterCallToProcessImage[0].length; j++) {
				System.out.print(afterCallToProcessImage[i][j] + " ");
			}
			System.out.println("");
		}
		System.out.println("");
		for (int i = 0; i < greyImage.getPixelValues().length; i++) {
			for (int j = 0; j < greyImage.getPixelValues()[0].length; j++) {
				System.out.print(greyImage.getPixelValues()[i][j] + " ");
			}
			System.out.println("");
		}
		// assert
